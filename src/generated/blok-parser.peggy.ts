...
// @ts-ignore
  var peg$startRuleFunctions = { BlokExpression: peg$parseBlokExpression };
// @ts-ignore
  var peg$startRuleFunction = peg$parseBlokExpression;
...
// @ts-ignore
  ...
  var peg$e5 = peg$literalExpectation("null", false);
  var peg$e6 = peg$classExpectation([["0", "9"]], false, false);
  var peg$e7 = peg$otherExpectation("\"");
  var peg$e8 = peg$literalExpectation("\"", false);
  var peg$e9 = peg$otherExpectation("String Character");
...
// @ts-ignore
 ...
 return text(); };// @ts-ignore
  ...
  var peg$f5 = function(v) {// @ts-ignore
 return v[1] === '"' ? '"' : v[0] + v[1]; };// @ts-ignore

  var peg$f6 = function(contents) {
// @ts-ignore
    	return contents
    };// @ts-ignore
...
// @ts-ignore
      s1 = // @ts-ignore
input.substring(s1, peg$currPos);
// @ts-ignore
    } else {
// @ts-ignore
      s1 = // @ts-ignore
...
// @ts-ignore
  function // @ts-ignore
peg$parseDoubleQuoteStringCharacter() {
// @ts-ignore
    var s0, s1, s2;
...
// @ts-ignore
      s3 = [];
// @ts-ignore
      s4 = peg$parseDoubleQuoteStringCharacter();
// @ts-ignore
      while (s4 !== peg$FAILED) {
// @ts-ignore
        s3.push(s4);
...
// @ts-ignore
      s2 = // @ts-ignore
input.substring(s2, peg$currPos);
// @ts-ignore
...
export type ParseFunction = <Options extends ParseOptions>(
    ...
    StartRule extends "BlokExpression" ? BlokExpression : BlokExpression
    : BlokExpression;
...
export type BlokExpression = [Term, ...TailPart[]];
export type Bool = boolean;
export type Null = null;
export type Number_1 = number;
export type DoubleQuote = '"';
export type DoubleQuoteStringCharacter = QuoteEscape | string;
